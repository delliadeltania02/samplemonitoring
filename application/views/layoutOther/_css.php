 ...
 <!--link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700&display=fallback"-->
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="<?php echo base_url('assets');?>/plugins/font.css">
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets');?>/plugins/summernote/summernote-bs4.min.css">
   <!-- Icon style -->
   <link rel="stylesheet" href="<?php echo base_url('assets');?>/dist/css/all.min.css">
   ...
   <link rel="stylesheet" href="<?php echo base_url('assets');?>/plugins/datatables-select/css/jquery.dataTables.min.css">
