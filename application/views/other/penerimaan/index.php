      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
                ...
                <li class="breadcrumb-item active">Received Sample Other Buyer</li>
                </ol>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-md-10" style="padding-bottom: 1%;">
            ...
            <div class="col-md-2" style="padding-bottom: 1%;">
              <a href="<?=site_url('c_transaksi/tambah_penerimaan_other')?>" type="button" class="btn btn-block"  value="Tambah" style="font-size: 11px; background-color: #36454F;color: white;"><i class="fa-solid fa-plus"></i> &nbsp;Add Data</a>
            </div>
            <div class="col-md-12">
                <div class="card">
                                ...
                                <table id="example1" class="table table-bordered table-striped table-sm text-nowrap">
                                    <thead>
                                      <tr>
                                          ...
                                          <th>Approved By (adidas strike)</th>
                                          <th>TOD</th>
                                          <th>Stage</th>
                                          <th>Size Category</th>
                                          <th>Sample Number</th>
                                    ...
                                    <tbody id="myTable">
                                      ...
                                      <tr>
                                            ...
                                            <td>
                                              <a href="<?=site_url('#')?>" data-target="#editModal" data-toggle="modal" class="btn btn-outline-info btn-sm button2"><i class="fa fa-edit"></i></a>
