          ...
          <div class="col-md-10" style="padding-bottom: 1%;">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form action = "<?php echo site_url('c_transaksi/editaksi_oekotex'); ?>" method="post">
                      <div class="card-body">    
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <input clas="form-contorl" name="id" type="text" value="<?= $u->id?>" hidden>
                            <input class="form-control" name="oekotex" type="text" value="<?= $u->oekotex ?>">
                          </div>
                        </div>	
                      </div>
                      <div class="card-footer">
                          <div class="col-md-1">
                            <a href="<?=site_url('c_transaksi/index_oekotex')?>" type="button" class="btn btn-block" style="background-color: #36454F;color: white;" >Back</a> 
                          </div>
                          <div class="col-md-10">
