      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
                ...
                <li class="breadcrumb-item active">Add OEKOTEX</li>
                </ol>
          </div>
        </div>
      </div>
          ...
          <div class="col-md-10" style="padding-bottom: 1%;">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form action = "<?php echo site_url('c_transaksi/tambahaksi_oekotex'); ?>" method="post">
                      <div class="card-body">    
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <input class="form-control" name="oekotex" type="text">
                          </div>
                        </div>	
                      </div>
