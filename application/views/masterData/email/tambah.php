      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
                ...
                <li class="breadcrumb-item active">Add Applicant Information</li>
                </ol>
          </div>
        </div>
      </div>
          ...
          <div class="col-md-10" style="padding-bottom: 1%;">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form action = "<?php echo site_url('c_transaksi/tambahaksi_email'); ?>" method="post">
                      <div class="card-body">    
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <input class="form-control" name="applicant" type="text">
                          </div>
                        </div>
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <select class="form-control" name="department">
                              ...
                              <?php foreach($department as $u):?>
                                <option value="<?= $u->id_department?>"><?= $u->department?></option>
                              <?php endforeach ?>
                            </select>
