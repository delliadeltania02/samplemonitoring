          ...
          <div class="col-md-10" style="padding-bottom: 1%;">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form action = "<?php echo site_url('c_transaksi/tambahaksi_material'); ?>" method="post">
                      <div class="card-body">    
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <input class="form-control" name="item_no" type="text">
                          </div>
                        </div>
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <input class="form-control" name="code_of_fabric" type="text">
                          </div>
                        </div>
                        <div class="col-md-12">
                          <div class="form-group">
