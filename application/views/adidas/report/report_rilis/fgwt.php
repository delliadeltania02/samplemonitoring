...
<html>
<head>
    <title>Finished Garment Wash Test Report</title>
...
<body>
    ...
    <header>
        ...
        <h1>Finished Garment Wash Test Report</h1>
    </header>
    <!-- FOOTER -->
    <footer>
        PT. KAHATEX<br>
    ...
    <div class="page-content">
        ...
        <table border="1"  class="gpc-table">
            ...
            <tr>
                ...
                <td>Quantity</td>
                <td><?= isset($report[0]) ? $report[0]->quantity_sample: 'N/A' ?></td>
                <td>Size</td>
            ...
            <tr>
                ...
                <td></td>
                <td>Delivery Date</td>
                <td><?= isset($report[0]) ? $report[0]->podd : 'N/A' ?></td>
                <td>Size</td>
                <td><?= isset($report[0]) ? $report[0]->size: 'N/A' ?></td>
            </tr>
        </table><br>
        <span style="font-size: 12px; font-weight: bold;">Washing Condition</span>
        <table border="1"  class="gpc-table">
            <tr>
                <td>Line Dry</td>
                <td></td>
            ...
            <tr>
                ...
                <td></td>
                <td>Machine Model</td>
                <td><?= isset($report[0]) ? $report[0]->machine_model: 'N/A' ?></td>
            </tr>
            <tr>
                <td>Hand Wash Cold</td>
                <td></td>
                <td>Fibre Composition</td>
                <td><?= isset($report[0]) ? $report[0]->fibre_com: 'N/A' ?></td>
            </tr>
        </table><br>
        <span style="font-size: 10px; font-weight: bold;">* Shrinkage and Spirality should be evaluated according to fabric structure and composition.</span><br>
        <span style="font-size: 10px; font-weight: bold;">* Please refer back to adidas apparel testing Method PHX-AP0701 Dimensional Change Spirality Appearance Change After Laundering</span>
        <table class="gpc-table">
            <thead>
                <tr>
                    <th rowspan="2" style="width: 220px;">General Property Check List</th>
                    <th colspan="2">before wash</th>
                    <th colspan="2">1. wash</th>
            ...
            <?php foreach ($ceklis as $u): ?>
                ...
                <?php 
                    // tampilkan hanya yang punya nilai
                    $has_value = 
                        (!empty($u['passfail']) && $u['passfail'] != '-') ||
                        (!empty($u['passfail1']) && $u['passfail1'] != '-');
                ...
                <tr>
                    ...
                    <!-- BEFORE WASH -->
                    <td class="center"><?= ($u['passfail']  == 'Accepted') ? 'V' : '' ?></td>
                    <td class="center"><?= ($u['passfail']  == 'Rejected') ? 'V' : '' ?></td>

                    <!-- 1st WASH -->
                    <td class="center"><?= ($u['passfail1'] == 'Accepted') ? 'V' : '' ?></td>
                    <td class="center"><?= ($u['passfail1'] == 'Rejected') ? 'V' : '' ?></td>

                    <td><center><?= $u['comment'] ?></center></td>
                </tr>
         ...
         <!-- SHRINKAGE -->
        <span style="font-size: 10px; font-weight: bold;">Actual Shrinkage %</span><br>
        <table border="1px;" class="gpc-table">
                 <thead>
                    <tr style="text-align: center;">
                        <td rowspan="2" ><b>Measureing position</b><br>according to ISO 3759</td>
                        <td rowspan="2">Before Wash</td>
                        <td colspan="2">1. wash</td>
                        <td colspan="2">3. wash**</td>
                        <td colspan="2">15. wash***</td>
                        <td rowspan="2">Comment</td>
                    </tr>
                    <tr>
                        <td><center>after wash</td>
                        <td><center>actual shrinkage</td>
                        <td><center>after wash</td>
                        <td><center>actual shrinkage</td>
                        <td><center>after wash</td>
                        <td><center>actual shrinkage</td>
                 ...
                 <tbody>
                    <?php
                        foreach($shrinkage as $u){
                    ?>
                    <tr>
                        <?php
                        $measurement = $u['measurement'];
                        $parts = explode('point', $measurement);

                        $hasil = isset($parts[1]) ? trim($parts[1]) : '';
                        ?>
                        <td><center><?= $hasil ?></td>
                        <td><center><?= $u['be_wash'] ?></td>
                        <td><center><?= $u['af_wash_1']?></td>
                        <td><center><?= $u['ac_wash_1'] ?></td>
                        <td><center><?= $u['af_wash_3'] ?></td>
                        <td><center><?= $u['ac_wash_3'] ?></td>
                        <td><center><?= $u['af_wash_15'] ?></td>
                        <td><center><?= $u['ac_wash_15'] ?></td>
                        <td><center><?= $u['comment'] ?></td>
                    </tr>
                    <?php } ?>
                 </tbody>
        </table>
        <span style="font-size: 10px; font-weight: bold;">* For full body garments only as combination of measuring positions for jacket like garment + trouser like garments (also see Annex)</span><br>
        <span style="font-size: 10px; font-weight: bold;">** 1x wash & 1x dry & IN : 1x wash & 1x Dry : 1x wash & dry & IN (if care label "line dry",  the 2nd drying could be skipped)</span><br>
        <span style="font-size: 10px; font-weight: bold;">*** 1x wash & 1x dry & IN : 4x wash & 1x dry & IN : 5x wash & 1x dry : 5x wash & 1x dry & IN</span>
        <br>
        <table style="width: 100%; border-collapse: collapse; font-size: 12px;">
            <tr>
                <!-- Pertanyaan -->
                <td style="width: 70%; padding: 5px;">
                    <b>Stretched Neck Opening is OK according to size spec?</b>
                </td>

                <!-- Yes -->
                <td style="width: 5%; text-align: right;">Yes</td>

                <!-- Kotak Yes -->
               <td style="border: 1px solid #000; text-align:center;">
                    <?= isset($report[0]->neck_yes) && in_array(strtolower($report[0]->neck_yes), ['yes', 'on']) ? 'V' : '' ?>
                </td>
                ...
                <!-- Kotak No -->
                <td style="border: 1px solid #000; text-align:center;">
                    <?= isset($report[0]->neck_no) && in_array(strtolower($report[0]->neck_no), ['no', 'on']) ? 'V' : '' ?>
                </td>
            </tr>
        </table><br>
        <table style="border-collapse: collapse; width: 350px; font-size: 12px;">
            <!-- Header kecil kiri atas -->
            <tr>
                <td colspan="2" 
                    style="border: 1px solid #000; border-bottom: none; padding: 2px 5px; font-weight: bold;">
                    Spirality
                </td>
            </tr>
            ...
            <!-- Body (%) -->
            <tr>
                <td style="border: 1px solid #000; width: 200px; padding: 2px 5px;">
                    Body (%)
                </td>
                <td style="border: 1px solid #000; text-align: right; padding: 2px 5px;">
                     <?= isset($report[0]) ? $report[0]->body : ' ' ?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="border: 1px solid #000; text-align: right; padding: 2px 5px;">
                    <?= isset($report[0]) ? $report[0]->sleeve : ' ' ?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="border: 1px solid #000; text-align: right; padding: 2px 5px;">
                    <?= isset($report[0]) ? $report[0]->sideseam : ' ' ?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="border: 1px solid #000; text-align: right; padding: 2px 5px;">
                   <?= isset($report[0]) ? $report[0]->sle_width : ' ' ?>
                </td>
            </tr>

            <!-- movement of side seam -->
            <tr>
                <td style="border: 1px solid #000; padding: 2px 5px;">
                    movement of side seam
                </td>
                <td style="border: 1px solid #000; text-align: right; padding: 2px 5px;">
                    <?= isset($report[0]) ? $report[0]->mov_sideseam : ' ' ?>
                </td>
            </tr>

            <!-- movement of sleeve opening -->
            <tr>
                <td style="border: 1px solid #000; padding: 2px 5px;">
                    movement of sleeve opening
                </td>
                <td style="border: 1px solid #000; text-align: right; padding: 2px 5px;">
                   <?= isset($report[0]) ? $report[0]->mov_sleeve : ' ' ?>
                </td>
            </tr>
        ...
        <div style="font-size: 11px; margin-top: 3px;">
            Note: refer to Annex for the marking and measurement
        </div><br>
        <table style="border-collapse: collapse; width: 100%; font-size: 12px;">
            ...
            <tr>
                ...
                <td style="border:1px solid #000; padding:4px;">Appearance of garment after wash</td>
        ...
        <div style="font-size:11px; margin-top:5px;">
            ** 1x wash & 1x dry & IN : 1x wash & 1x dry : 1x wash & 1x dry & IN (if care label “line dry”, the 2nd drying could be skipped)
            <br>
            *** 1x wash & 1x dry & IN : 4x wash & 1x dry & IN : 5x wash & 1x dry & IN : 5x wash & 1x dry & IN
        </div>
