                    ...
                    <div class="card card-navy">
                        ...
                        <div class="card-footer">
                            <div class="row justify-content-between"> 
                                <div class="col-md-3">
                                    <a href="<?= site_url('#') ?>" class="btn btn-block" style="background-color: #001f3f; color: white;">Back</a>
                                </div>
                                <div class="col-md-3">
                                    <button type="submit" class="btn btn-block" style="background-color: #001f3f; color: white;">Submit</button>
                                </div>
                            </div>
                        </div>
